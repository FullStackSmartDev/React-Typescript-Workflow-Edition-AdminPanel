...
import "./PharmacyInfoSearch.scss";

interface Props {}
interface State {}

const {Option} = Select;
class PharmacyInfoSearch extends Component<Props, State> {
  state = {};

  render() {
    return (
      <div className="PharmacyInfoSearch">
        <Grid container className="phramacy-search-tab-container">
          <Grid
            container
            item
            className="pharmacy-search-member-info-container"
          >
          ...
          <Grid
            container
            className="pharmacy-search-pharmacy-information-container"
          >
            <Grid item sm={4} className="pharmacy-informatin-heading">
              Pharmacy Information
            </Grid>
            <Grid item sm={4} className="pharmacy-information-search-fields">
              <Input
                className="member-search__input"
              ...
              <Input
                ...
                //   onChange={(e) => this.handleInputChange(e)}
              />
              <div className="pharamcy-search-select-filed">
                <DropDown
              ...
              <Grid
                item
                container
                className="pharamcy-search-state-zip-container"
                // direction="column"
                sm={12}
              >
                <Grid item sm={5} className="pharamcy-searhc-state-select">
                  <DropDown
                    placeholder="State"
                    className="member-search__input--dropdown"
                    // dropdownClassName="formulary-service-year-dropdown"
                ...
                <Grid item sm={5} className="pharamcy-search-zipcode-input">
                  <Input
                    className="member-search__input"
...
export default PharmacyInfoSearch;
