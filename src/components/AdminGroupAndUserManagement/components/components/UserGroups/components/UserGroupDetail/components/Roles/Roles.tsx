...
import { getUserGroupsRolesList } from "../../../../../../../../../mocks/grid/admin-roles-mock";
import "./Roles.scss"
...
export default class Roles extends React.Component<any, any> {
    state = {
        RolesList: getUserGroupsRolesList()
    }

    addIconClick = (id: number) => {
        let selectedURolesItem = this.state.RolesList.find(p=>p.id === id);
        if(selectedURolesItem != undefined){
            selectedURolesItem.isIconClick = true;
        }
        
        this.setState({RolesList: this.state.RolesList.map(el => (el.id === id ? {...el, selectedURolesItem}:el))
    ...
    subtractIconClick = (id: number) => {
        let selectedURolesItem = this.state.RolesList.find(p=>p.id === id);
        if(selectedURolesItem != undefined){
            selectedURolesItem.isIconClick = false;
        }
            ...
            return (
                <ul>
                    <li>
                        ...
                        <div className="bottom">{RolesList.company}</div>
                    </li>
                    <li>
                    <EyeIcon />
        ...
        return <>
            ...
            <div className="lower-container customer-con">
                    ...
                    <div className="grid-container-header-wrapper">
                        ...
                        <div className="module-search field-container last_contain">
                            <InputLabel htmlFor="module-search">Module:</InputLabel>
                            <DropDown
