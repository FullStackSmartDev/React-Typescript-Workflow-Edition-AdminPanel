...
import TabletDetailsMapInfoPopup from './TabletDetailsMapInfo';
import DrugPopup2 from '../../assets/img/DrugPopup2.png';
import { drugBrandData, timeData } from '../../mocks/BestPriceDrugMock';

import Messages from '../../constants/Messages';

import "./TabletDetailsInfoPopup.scss";

interface TabletDetailsInfoPopupProps {
    isOpen: boolean;
    onClose: () => void;
    mapData: any;
    description: string;
...
class TabletDetailsInfoPopup extends React.Component<TabletDetailsInfoPopupProps> {
    state = {
            ...
            <div>
                ...
                <React.Fragment>
                    <DialogPopup
                        ...
                        showActions={false}
                        className="tablet-details-info-popup-root"
                    >
                                ...
                                <div className="TabletBodyDetails">
                                    <div className="TabletBodyDetails__leftside">
                                        ...
                                        <div className="TabletBodyDetails__leftside_typography">
                                            ...
                                            <p>{title} is used to treat relapsing multiple sclerosis (MS) in adults, and children and adolescents aged 10 years and older.</p>
                                            <p>{title} will not cure MS, it will only decrease the frequency of relapse symptoms.</p>
                                        </div>
                                    </div>
                                                ...
                                                <div className="TabletBodyDetails__rightside_box">
                                                    <div className="TabletBodyDetails__rightside_container">
                                                        <Radio.Group onChange={this.onChange} value={this.state.radioValue}>
                                                            <label className="container">
                                                                <div className="label">
                                                                    <span className="brandName"> Brand: Gileyna </span><br />
                                                                    <span className="brandValue"> $50.00 <span className="brandValueText">Copay</span></span>
                                                                </div>
                                                    ...
                                                    <div className="TabletBodyDetails__data_container" >
                                                        ...
                                                        {this.state.isTimeToggle ? (<div className="hours-container">
                                                            {item.workingHours.map((_item: any) => (
...
export default TabletDetailsInfoPopup;
