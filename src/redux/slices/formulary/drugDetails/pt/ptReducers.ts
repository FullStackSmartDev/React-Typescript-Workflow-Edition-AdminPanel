...
export const postPTListFulfilled = (state, action) => {
  console.log("Reducer::postPTListFulfilled");
  state.isLoading = false;
  console.log(action);
  if (
    ...
    console.log("postPTListFulfilled: Payload invalid");
    return;
  }
...
export const postPTListRejected = (state, action) => {
  console.log("Reducer::postPTListRejected");
  state.isLoading = false;
  state.applyData = {};
};
