...
interface AdvGridOtherSearchProps {
    
}

interface AdvGridOtherSearchState {
    memberInfo: string;
    claimId: string;
    drugLabel: string;
    rx: string;
...
class AdvGridOtherSearch extends React.Component<AdvGridOtherSearchProps, AdvGridOtherSearchState> {
    state = {
        memberInfo: "",
        claimId: "",
        drugLabel: "",
    ...
    if (
      ...
      if (Object.keys(this.state).includes(key)) {
        this.setState({ ...this.state, [key]: value } as Pick<
            AdvGridOtherSearchState,
          keyof AdvGridOtherSearchState
        >);
      }
    }
          ...
          <div>
            <div className="advanced-grid-search__first-row">
              ...
              <CustomDatePicker
                ...
                placeholder="Communication Start Date"
              />
              <CustomDatePicker
                className="advanced-grid-search__input advanced-grid-search__input--date"
                onChange={this.handleStartDate}
                value={this.state.startDate}
                placeholder="Communication End Date"
              />
            </div>
          </div>
...
export default AdvGridOtherSearch;
