...
import OutgoingCommunication from "./OutgoingCommunication/OutgoingCommunication";
import RenameLevel from "./RenameLevel/RenameLevel";
import "./styles.scss";
const marginLeft = 19;

export default class Heirarchy extends React.Component<any, any> {
  state = {
    modalStatus: false,
    type: "",
  };
