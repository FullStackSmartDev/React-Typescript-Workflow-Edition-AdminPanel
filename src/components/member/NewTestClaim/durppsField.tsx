...
export default function DurppsField(props: any) {
    return (
                ...
                <Grid container spacing={1}>
                    <Grid item>
                        <div className="input">
                            <Autocomplete
                                ...
                                freeSolo
                                placeholder="Search"
                                options={drugsSearch['Reason For Service Code'].map((option) => `${option.Code}:  ${option.Meaning}`)}
                                renderInput={(params) => (
                    ...
                    <Grid item>
                        <div className="input">
                                <Autocomplete
                                        ...
                                        freeSolo
                                        placeholder="Search"
                                        options={drugsSearch['Professional Service Code'].map((option) => `${option.Code}:  ${option.Meaning}`)}
                                        renderInput={(params) => (
                                        <TextField {...params} placeholder="Search" InputProps={{
                                            ...params.InputProps,
                                            startAdornment: <span>{
                    ...
                    <Grid item>
                        ...
                        <Autocomplete
                                ...
                                freeSolo
                                placeholder="Search"
                                options={drugsSearch['Result of Service Code'].map((option) => `${option.Code}:  ${option.Meaning}`)}
                                renderInput={(params) => (
                                <TextField {...params} placeholder="Search" InputProps={{
                                    ...params.InputProps,
                                    startAdornment: <span>{
