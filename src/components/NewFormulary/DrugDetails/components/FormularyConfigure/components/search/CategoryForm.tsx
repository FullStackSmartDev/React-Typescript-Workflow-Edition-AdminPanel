                ...
                <div className="main-wrapper">
                    <div className="row-wrapper">
                        ...
                        <div className="delete-wrapper">
                            <Box component="span" display="block" onClick={() => this.props.deleteField(this.props.index)}>
