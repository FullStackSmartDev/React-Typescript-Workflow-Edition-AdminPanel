...
interface ProfileClaimGridSearchState {
    memberInfo: string;
    claimId: string;
    drugLabel:string;
    rx: string;
...
interface ProfileClaimGridSearchProps {
    onSearch: (searchObject: ProfileClaimGridSearchState) => void;
}

interface GridAdvancedTestClaimsSearchProps { }

class ProfileClaimGridSearch extends React.Component<
ProfileClaimGridSearchProps,
ProfileClaimGridSearchState
    > {
    state = {
        memberInfo: "",
        claimId:"",
        ...
        if (
            ...
            if (Object.keys(this.state).includes(key)) {
                this.setState({ ...this.state, [key]: value } as Pick<
                    ProfileClaimGridSearchState,
                    keyof ProfileClaimGridSearchState
                >);
            }
        }
    ...
    render() {
        ...
        return (
            <div className="profile-claim-grid-search">
                <div>
                    <div className="profile-claim-grid-search__first-row">
                        <div className="profile-claim-grid-search__input-field">
                        <TextBox
                             className="profile-claim-grid-search__input"
                        ...
                        />
                        <svg className="profile-claim-grid-search__icon" width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="profile-claim-grid-search__first-row">
                        <CustomDatePicker
                            className="profile-claim-grid-search__input profile-claim-grid-search__input--date"
                            onChange={this.handleStartDate}
                            value={this.state.startDate}
                            placeholder="Fill Date Start"
                        />
                        <CustomDatePicker
                            className="profile-claim-grid-search__input profile-claim-grid-search__input--date"
                            onChange={this.handleStartDate}
                            value={this.state.startDate}
                            placeholder="Fill Date End"
                        />
                        <div className="profile-claim-grid-search__input-field">
                        <TextBox
                             className="profile-claim-grid-search__input"
                            placeholder="Drug Label Name"
                            type="text"
                            name="drugLabel"
                            value={drugLabel}
                            onChange={e => this.handleInputChange(e)}
                    ...
                    <div className="profile-claim-grid-search__action">
                    <Button className="profile-claim-grid-search__btn-clear">
                        <svg className="profile-claim-grid-search__btn-clear--clearicon" width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <Button
                        className="profile-claim-grid-search__btn-search"
...
export default ProfileClaimGridSearch;
