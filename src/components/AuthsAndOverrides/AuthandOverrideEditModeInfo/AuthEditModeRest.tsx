...
//components
import {memberInfo3} from "../../../mocks/grid/AuthGridModelMockData";
import {
  memberInfo1,
  refillsSection1,
  restSection1,
...
class AuthEditModeBlank extends React.Component<AuthEditModeInfoProps> {
  state = {
    ...
    refillsSection: refillsSection1,
            ...
            <div className="authadmin-info-root__content--data">
              <div className="authadmin-info-root__content--data-section">
                <div className="fields">
                  <label>
                    Total Refills Allowed <span className="important">*</span>
                  </label>
                  <span>
                    <Input
                      className="authedit-info-root__input"
                      placeholder="Total Refills Allowed"
                      defaultValue={refillsSection.totalReffills}
                      name="totalRefills"
                    />
                  </span>
                </div>
                <div className="fieldscenter">
                  ...
                  <span>
                    <Input
                      ...
                      defaultValue={refillsSection.refillsUsed}
                      name="refillsUsed"
                    />
                  </span>
                </div>
                <div className="endfields">
                  ...
                  <span>
                    <Input
                      ...
                      defaultValue={refillsSection.refillsRemaining}
              ...
              <div className="authadmin-info-root__content--data-sectionrow">
                <div className="fields">
                  ...
                  <Select
                    // style={{width: "100%", marginRight: "10px"}}
                    placeholder={refillsSection.productType}
                    dropdownStyle={{zIndex: 2000}}
                    dropdownAlign={{
                      offset: [-1, -4],
                      overflow: {
                ...
                <div className="fieldsright">
                  ...
                  <Select
                    placeholder="Yes"
                    defaultValue={refillsSection.applyMutli}
                    dropdownStyle={{zIndex: 2000}}
                    dropdownAlign={{
                      offset: [-1, -4],
                      overflow: {
                ...
                <Grid container spacing={3}>
                  <Grid item xs={12} sm={6}>
                    <div className="fieldspre">
                      ...
                      <span>
                        <Select
                          placeholder={restSection.prescriberType}
                          dropdownStyle={{zIndex: 2000}}
                          dropdownAlign={{
                            offset: [-1, -4],
                            overflow: {
                      ...
                      <div className="tablefields">
                        ...
                        <span>
                          <Input
                            className="authtableedit-info-root__input"
                            placeholder="Prescriber ID"
                            defaultValue={restSection.prescriberId}
                            name="prescriberID"
                          />
                        </span>
                      </div>
                  ...
                  <Grid item xs={12} sm={6}>
                    <div className="fieldspre">
                      ...
                      <span>
                        <Select
                          placeholder={restSection.pharmacyType}
                          dropdownStyle={{zIndex: 2000}}
                          dropdownAlign={{
                            offset: [-1, -4],
                            overflow: {
                      ...
                      <div className="tablefields">
                        ...
                        <span>
                          <Input
                            className="authtableedit-info-root__input"
                            placeholder="Pharmacy ID"
                            defaultValue={restSection.pharmacyId}
                            name="pharmacyID"
                          />
                        </span>
                      </div>
                      <div className="tablefields spacepad">
                        ...
                        <span>
                          <Input
                            className="authtableedit-info-root__input"
                            placeholder="Pharmacy Name"
                            defaultValue={restSection.pharmacyName}
                            name="pharmacy"
                          />
                        </span>
                      </div>
