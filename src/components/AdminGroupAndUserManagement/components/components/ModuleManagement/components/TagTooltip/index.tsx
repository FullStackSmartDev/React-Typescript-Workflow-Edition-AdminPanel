...
class TagTooltip extends React.Component<any, TagTooltipState> {
  handleEditClick = () => {
  ...
  renderToolTipContent = () => {
    const { id, administeredBy, moduleProvidedBy, participants, onEditClick } = this.props;

    return (
      <div className="tooltip-content" key={id}>
        <div className="tooltip-content__header">
          <div className="edit-icon-container">
            <EditIcon className="edit-icon" onClick={this.handleEditClick}/>
          </div>
        ...
        <div className="tooltip-content__body">
          <div className="tooltip-content__body-left">
            <div className="content-list-item">
              <div className="content-list-item__label">Administered By:</div>
              <div className="content-list-item__value">
                {administeredBy || ""}
              </div>
            </div>
            <div className="content-list-item">
              <div className="content-list-item__label">
                Module Provided By:
              </div>
              <div className="content-list-item__value">
                {moduleProvidedBy || ""}
          ...
          <div className="tooltip-content__body-right">
            <div className="content-list-item">
              <div className="content-list-item__label">Participants:</div>
              <div className="content-list-item__value">
                {participants &&
                  participants.map((p, k) => <div key={k}>{p}</div>)}
              </div>
            </div>
          </div>
        </div>
