...
interface GridAdvancedPharmacySearchState {
    pharmacyName: string;
    memberInfo: string;
    npi: string;
    ncpdp: string;
...
interface GridAdvancedPharmacySearchProps { }

class GridAdvancedPharmacySearch extends React.Component<
GridAdvancedPharmacySearchProps,
GridAdvancedPharmacySearchState
    > {
    state = {
        pharmacyName: "",
        memberInfo: "",
        ...
        if (
            ...
            if (Object.keys(this.state).includes(key)) {
                this.setState({ ...this.state, [key]: value } as Pick<
                    GridAdvancedPharmacySearchState,
                    keyof GridAdvancedPharmacySearchState
                >);
            }
        }
...
export default GridAdvancedPharmacySearch;
