...
export default function AvailableUsers() {
  ...
  const rows = [
    ...
    ["Jane Cooper ", "Domain or Company"],
    ["Emmitt Harris ", "Domain or Company"],
    ["Cody Fisher ", "Domain or Company"],
    ["Courtney Henry", "Domain or Company"],
    ["Cameron Williamson", "Domain or Company"],
  ];

  return (
        <div className="available-users">
        <Container>
            <FormLabel className='label'>Available Users:</FormLabel>
        <Grid
            container
            direction="row"
            justify="center"
