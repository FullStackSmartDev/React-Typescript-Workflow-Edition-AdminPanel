...
class AdministratorTooltipForm extends React.Component<any, TagTooltipState> {
  handleEditClick = () => {
  ...
  handleDateChange = (e) => {
    console.log("Add Administrator Date Change", e)
  }
      ...
      <div className="tooltip-form-content">
        ...
        <div className="outside-vendor-form-container"> 
          ...
          <div className="form-field form-field--date">
            <div className="form-field__label">Effective Date:</div>
            <div className="form-field__date">
            <DatePicker onChange={this.handleDateChange} style={{height: '37px', width: "100%"}}/>
            </div>
          </div>

          <div className="form-field form-field--date">
            <div className="form-field__label">Termination Date:</div>
            <div className="form-field__date">
              <DatePicker onChange={this.handleDateChange} style={{height: '37px', width: "100%"}}/>
            </div>
          </div>
  ...
  render() {
    return (
      <div id="administrator-form">        
        <Tooltip
          overlayClassName="administrator-form"
...
export default AdministratorTooltipForm;
