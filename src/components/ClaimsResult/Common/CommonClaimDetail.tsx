...
// import "./CommonClaimDetail.scss";
import "../../ClaimsGridModel/Components/ClaimDetail/ClaimDetail.scss";
...
} from "../../ClaimsGridModel/Components/ClaimDetail/Components/PDEStatusDialog/PDEStatusDialog";
...
class CommonClaimDetail extends React.Component<ClaimDetailProps, any> {
  constructor(props) {
    super(props);
    this.state = {
      ...
      <div className="claim-detail-root scroll-bar">
        <Grid container item md={12}>
          <div className="claim-detail-root__info-box">
            <FrxMiniTab
              tabList={detailsMiniTab}
              activeTabIndex={detailsActiveTabIndex}
              onClickTab={handleDetailsMinitabClick}
            />
...
export default CommonClaimDetail;
