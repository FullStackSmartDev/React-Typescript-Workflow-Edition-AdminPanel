...
interface GridAdvancedGrievenceSearchState {
...
interface GridAdvancedGrievenceSearchProps { }

class GridAdvancedGrievenceSearch extends React.Component<
GridAdvancedGrievenceSearchProps,
GridAdvancedGrievenceSearchState
    > {
    state = {
        prescriberFirstName: "",
        prescriberLastName:"",
        ...
        if (
            ...
            if (Object.keys(this.state).includes(key)) {
                this.setState({ ...this.state, [key]: value } as Pick<
                    GridAdvancedGrievenceSearchState,
                    keyof GridAdvancedGrievenceSearchState
                >);
            }
        }
...
export default GridAdvancedGrievenceSearch;
