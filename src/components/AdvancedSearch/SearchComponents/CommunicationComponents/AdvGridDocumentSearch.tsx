...
interface AdvGridDocumentSearchProps {
    
}

interface AdvGridDocumentSearchState {
    memberInfo: string;
    claimId: string;
    drugLabel: string;
    rx: string;
...
class AdvGridDocumentSearch extends React.Component<AdvGridDocumentSearchProps, AdvGridDocumentSearchState> {
    state = {
        memberInfo: "",
        claimId: "",
        drugLabel: "",
    ...
    if (
      ...
      if (Object.keys(this.state).includes(key)) {
        this.setState({ ...this.state, [key]: value } as Pick<
            AdvGridDocumentSearchState,
          keyof AdvGridDocumentSearchState
        >);
      }
    }
...
export default AdvGridDocumentSearch;
