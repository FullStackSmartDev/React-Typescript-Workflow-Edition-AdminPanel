...
interface GridAdvancedClaimsSearchState {
    memberInfo: string;
    claimId: string;
    drugLabel:string;
    rx: string;
...
interface GridAdvancedClaimsSearchProps { }

class GridAdvancedClaimsSearch extends React.Component<
GridAdvancedClaimsSearchProps,
GridAdvancedClaimsSearchState
    > {
    state = {
        memberInfo: "",
        claimId:"",
        ...
        if (
            ...
            if (Object.keys(this.state).includes(key)) {
                this.setState({ ...this.state, [key]: value } as Pick<
                    GridAdvancedClaimsSearchState,
                    keyof GridAdvancedClaimsSearchState
                >);
            }
        }
                ...
                <div>
                    ...
                    <div className="advanced-grid-search__first-row">
                        ...
                        <CustomDatePicker
                            ...
                            placeholder="Date Submitted begin"
                        />
                        <CustomDatePicker
                            className="advanced-grid-search__input advanced-grid-search__input--date"
                            onChange={this.handleStartDate}
                            value={this.state.startDate}
                            placeholder="Date Submitted end"
                        />
                    </div>
                    <div className="advanced-grid-search__first-row">
                        <CustomDatePicker
                            ...
                            onChange={this.handleStartDate}
                            value={this.state.startDate}
                            placeholder="Date of Service begin"
                        />
                        <CustomDatePicker
                            className="advanced-grid-search__input advanced-grid-search__input--date"
                            onChange={this.handleStartDate}
                            value={this.state.startDate}                                                                                                                                                                                                                                        
                            placeholder="Date of Service end"
                        />
                    </div>
                    </div>
...
export default GridAdvancedClaimsSearch;
