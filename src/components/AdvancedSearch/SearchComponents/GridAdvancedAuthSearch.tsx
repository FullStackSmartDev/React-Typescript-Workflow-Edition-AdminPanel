...
interface GridAdvancedAuthSearchState {
  memberInfo: string;
  claimId: string;
  drugLabel: string;
  rx: string;
...
interface GridAdvancedAuthSearchProps {}

class GridAdvancedAuthSearch extends React.Component<
  GridAdvancedAuthSearchProps,
  GridAdvancedAuthSearchState
> {
  state = {
    memberInfo: "",
    claimId: "",
    ...
    if (
      ...
      if (Object.keys(this.state).includes(key)) {
        this.setState({...this.state, [key]: value} as Pick<
          GridAdvancedAuthSearchState,
          keyof GridAdvancedAuthSearchState
        >);
      }
    }
  ...
  render() {
    const options = ["Restrictive", "Clinical", "Administrative"];
    const {
      memberInfo,
      claimId,
      drugLabel,
...
export default GridAdvancedAuthSearch;
