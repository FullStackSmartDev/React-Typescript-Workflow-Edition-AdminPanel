...
interface GridAdvancedMemberSearchState {
    firstName: string;
    lastName: string;
    memberInfo: string;
...
class GridAdvancedMemberSearch extends React.Component<
GridAdvancedMemberSearchProps,
GridAdvancedMemberSearchState
    > {
    state = {
        firstName: "",
        lastName:"",
        ...
        if (
            ...
            if (Object.keys(this.state).includes(key)) {
                this.setState({ ...this.state, [key]: value } as Pick<
                    GridAdvancedMemberSearchState,
                    keyof GridAdvancedMemberSearchState
                >);
            }
        }
    ...
    render() {
        ...
        const {firstName, lastName, memberInfo, startDate} = this.state;
        return (
            <div className="advanced-grid-search">
                    ...
                    <Button
                        ...
                        disabled={
                            firstName === "" || lastName === "" || memberInfo === "" || startDate ? true : false
                        }
                    >
                        Search
                    </Button>
...
export default GridAdvancedMemberSearch;
